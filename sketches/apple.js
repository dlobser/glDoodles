...
rainbow.prototype.makeTube = function(){
    ...
    for(var i = 0 ; i < this.curves.length ; i++){
        ...
        var tube = new THREE.Mesh(new THREE.TubeGeometry(new THREE.SplineCurve3( this.curves[i]), this.curveDetail ),new THREE.MeshLambertMaterial( {color:Math.sin(i+data.var2)*0xffffff}));
        ...
        var tube2 = new THREE.Mesh(new THREE.TubeGeometry(new THREE.SplineCurve3( this.curves[i]), this.curveDetail ),new THREE.MeshLambertMaterial( {color:Math.sin(i+data.var2)*0xffffff}));
    ...
    var lcp = [];
    for(var i = 0 ; i < this.curveDetail+1 ; i++){
        lcp.push(latheCurve.getPointAt(i/this.curveDetail));
    }
    ...
    var lathe = new THREE.Mesh(
        ...
        new THREE.MeshLambertMaterial( {side:THREE.DoubleSide,color:Math.sin(i+data.var3)*0xffffff} ));
